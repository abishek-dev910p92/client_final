...
function addbanner(){
  ...
  let currentAd = 0;
  const adLink = document.querySelector('.ads-banner a');
  const adImage = document.querySelector('.ads-banner img');
  
  function showAd(index) {
    adImage.src = ads[index].img;
    adImage.alt = ads[index].alt;
